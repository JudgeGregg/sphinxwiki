...
Aside from hiding the details of the issue while development is ongoing, all of the normal policies apply; security fixes require unit tests, etc.  See `ReviewProcess <{filename}/pages/ReviewProcess.rst>`_ for further details.
